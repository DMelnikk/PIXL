    ...
    <div class="grow border-b border-pixl-light/10 pb-5 pt-1.5">
        <div class="flex justify-between items-center gap-4">
            <div class="flex gap-2.5 items-center">
                ...
                <p class="text-xs text-pixl-light/40">{{$item->postedDateTime}}</p>
                <p>
                    <a class="hover:text-pixl-light/60 text-xs text-pixl-light/40" href="/profile">{{$item->profile->handle}}</a>
                </p>
            </div>
        ...
        <div class="mt-6 flex justify-between items-center gap-4">
            <div class="flex items-center gap-8">
                ...
                <div class="flex items-center gap-1">
                    ...
                    <span class="text-xs">{{$item->replyCount}}</span>
                </div>
                <!-- Re-post -->
                <div class="flex items-center gap-1">
                    ...
                    <span class="text-xs">{{$item->repostCount}}</span>
                </div>
            </div>
