...
<main class="flex flex-col grow gap-4 overflow-y-auto py-4 px-4 -mx-4">
    ...
    <div class="flex mt-8 items-start gap-4 border-b border-pixl-light/10 pb-4">
        ...
        <form class="grow" action="">
            ...
            <div class="flex justify-between gap-4 items-center">
                ...
                <button type="submit" class="bg-pixl hover:bg-pixl/90 border active:bg-pixl/95 border-transparent px-4 py-1 text-pixl-dark text-sm">Post</button>
            </div>
        </form>
    </div>
    ...
    <ol class="mt-4">
        ...
        <li class="flex items-start gap-4 not-first:pt-2.5">
            <a href="/profile" class="shrink-0">
                <img src="/images/simon-chilling.png" alt="Avatar for Michael" class="size-10 object-cover">
            </a>
            <div class="grow pt-1.5">
                <div class="border-b border-pixl-light/10 pb-5">
                    ...
                    <div class="flex justify-between items-center gap-4">
                        <div class="flex gap-2.5 items-center">
                            ...
                            <p class="text-xs text-pixl-light/40">3h</p>
                            <p>
                                <a class="hover:text-pixl-light/60 text-xs text-pixl-light/40" href="/profile">@mmich_jj</a>
                            </p>
                        </div>
                    ...
                    <div class="mt-6 flex justify-between items-center gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <span class="text-xs text-pixl-light/40">Save</span>
                            </div>
                            <!-- Share  -->
                            <div class="flex items-center gap-1">
                    ...
                    <div class="flex mt-8 items-start gap-4 border-t bg-pixl-light/[3%] border-pixl-light/10 p-4">
                        ...
                        <form class="grow" action="">
                            ...
                            <textarea
                                class="text-sm w-full resize-none"
                                rows="5"
                                name="reply" d
                                id="reply"
                                placeholder="Replys to Michael's post"
                            ></textarea>
                            <div class="flex justify-between gap-4 items-center">
                                <div class="flex gap-4">
                                    <button type="button">
                                ...
                                <button type="submit" class="bg-pixl/15 hover:bg-pixl/20 border active:bg-pixl/20 border-transparent px-4 py-1 text-pixl text-sm">Post</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <ol>
                    <!-- Reply -->
                    <li class="relative flex items-start gap-4 pt-4 group/li">
                        <!-- Line through -->
                        <div aria-hidden="true" class="absolute top-0 left-5 w-px h-full group-last/li:h-4  bg-pixl-light/10">

                        </div>
                        <a href="/profile" class="shrink-0 isolate">
                            <img src="/images/simon-chilling.png" alt="Avatar for Alex" class="size-10 object-cover">
                        </a>
                        <div class="grow border-b border-pixl-light/10 pb-5 pt-1.5">
                            <div class="flex justify-between items-center gap-4">
                                <div class="flex gap-2.5 items-center">
                                    <p><a class="hover:underline" href="/profile">Alex</a></p>
                                    <p class="text-xs text-pixl-light/40">1h</p>
                                    <p>
                                        <a class="hover:text-pixl-light/60 text-xs text-pixl-light/40" href="/profile">@alex-in-paris</a>
                                    </p>
                                </div>
                                <button class="flex gap-[3px] group py-2" aria-label="Post options">
                                    <span class="size-1 bg-pixl-light/40 group-hover:bg-pixl-light/60"></span>
